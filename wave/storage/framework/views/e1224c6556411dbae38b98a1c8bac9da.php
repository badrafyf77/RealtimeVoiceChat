<div x-data="{
    ...
    <div class="pb-5 mb-5 border-b border-zinc-200">
        ...
        <div class="flex flex-col items-start w-full h-auto">
            <!--[if BLOCK]><![endif]--><?php if(isset($favicon_light) && $favicon_light != ''): ?>
    ...
    <div class="pb-5 mb-5 border-b border-zinc-200">
        ...
        <div class="flex flex-col items-start w-full h-auto">
            <!--[if BLOCK]><![endif]--><?php if(isset($favicon_dark) && $favicon_dark != ''): ?>
...
</div><?php /**PATH /Users/afyfbadreddine/Herd/mywave/vendor/devdojo/auth/src/../resources/views/livewire/setup/favicon.blade.php ENDPATH**/ ?>